...
window.onscroll = () => {
    if(tracks.offsetTop-50< window.pageYOffset && window.pageYOffset<4180){
    ...
    else if(faq.offsetTop-50< window.pageYOffset && window.pageYOffset<sponsors.offsetTop-50){
        nav.children[0].firstChild.classList.remove("reached");
        nav.children[1].firstChild.classList.add("reached");
        nav.children[2].firstChild.classList.remove("reached");
        nav.children[3].firstChild.classList.remove("reached");
    }
    else if(itinerary.offsetTop-60< window.pageYOffset && window.pageYOffset<5031.2001953125){
        nav.children[0].firstChild.classList.remove("reached");
        nav.children[1].firstChild.classList.remove("reached");
    ...
    else if(sponsors.offsetTop-50< window.pageYOffset && window.pageYOffset<7869.60009765625){
        nav.children[0].firstChild.classList.remove("reached");
        nav.children[1].firstChild.classList.remove("reached");
        nav.children[2].firstChild.classList.remove("reached");
